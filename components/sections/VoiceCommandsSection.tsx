...
function CommandCard({
  ...
  return (
    <motion.div
      ...
      className="relative flex items-center gap-3 bg-white shadow-sm rounded-xl px-4 py-3"
    >
      <div className="w-8 h-8 rounded-lg bg-apple-blue/10 flex items-center justify-center text-apple-blue text-xs font-bold shrink-0">
        {cmd.icon}
      </div>

      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-0.5">
          <span className="text-[10px] font-semibold tracking-widest text-ink-muted-80 uppercase">
            You said
          </span>
          <motion.span
        ...
        <div className="flex items-center gap-2">
          <motion.div
            className="h-px flex-1 bg-black/5"
            initial={{ scaleX: 0 }}
          ...
          />
          <motion.span
            className="text-xs font-semibold text-apple-blue shrink-0"
...
export default function VoiceCommandsSection() {
  ...
  return (
    <section className="bg-canvas-parchment py-20 sm:py-28 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            <motion.div
              className="bg-white shadow-sm rounded-2xl p-5"
            ...
            >
              <div className="flex items-center gap-2 mb-4 px-1">
                ...
                <span className="text-[10px] font-semibold tracking-widest text-ink-muted-80 ml-2 uppercase">
                  Command Log
                </span>
                <motion.div
              ...
              >
                <div className="flex items-center justify-between px-1">
                  ...
                  <div className="flex items-center gap-1.5 text-apple-blue text-xs font-semibold">
          ...
          >
            <div className="relative">
              ...
              >
                <p className="text-xs font-semibold tracking-widest text-apple-blue mb-3">
                  HOW IT WORKS
                </p>
                <h3 className="text-2xl font-bold text-ink mb-4">
                  Your voice is the remote control.
                </h3>
                <p className="text-ink-muted-48 text-sm leading-relaxed mb-6">
              ...
              >
                {[
                  ...
                  >
                    ...
                    <p className="text-[11px] text-ink-muted-48">{stat.desc}</p>
                  </motion.div>
                ))}
              </motion.div>
              ...
              >
                {categories.map((cat, i) => (
                  <motion.span
                    ...
                    className="inline-block px-3 py-1.5 rounded-full text-xs font-medium bg-white shadow-sm text-ink"
                    whileHover={{
                      scale: 1.05,
                      borderColor: "#007AFF",
                      color: "#007AFF",
