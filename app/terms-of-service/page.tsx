    ...
    <>
      ...
      <main className="pt-24 pb-16 bg-canvas-parchment">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <p className="text-sm text-ink-muted-80 mb-2">Last updated: June 2025</p>
          <h1 className="text-3xl sm:text-4xl font-bold text-ink mb-8">
            Terms of Service
          </h1>

          <div className="max-w-none">
            <h2 className="text-xl font-semibold text-ink mt-8 mb-4">
            ...
            <p className="text-ink-muted-48 mb-4 leading-relaxed">You may not:</p>
            <ul className="list-disc pl-6 text-ink-muted-48 mb-4 space-y-1">
